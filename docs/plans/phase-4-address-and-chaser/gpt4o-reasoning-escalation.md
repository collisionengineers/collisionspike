...
- **PII minimisation before send.** Send only the photos needed (≤3–4) and only the required text clues; do not dump full case PII. Plates are intrinsic to the image — note in the DPIA.
