...
research-link: docs/tickets/backlog/TKT-207-bulk-case-registration-lock-budget/evidence/operator-note.md
plan: PLAN-004
---
...
`tr_case_registration_*` in `migration/assets/schema/900_constraints.sql`) that takes a
