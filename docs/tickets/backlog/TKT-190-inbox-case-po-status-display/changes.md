# Changes — TKT-190: Show complete case details in inbox statuses
...
## Implementation log
- PENDING — record inventory totals, repair decisions, changed files and test results when implementation begins.
