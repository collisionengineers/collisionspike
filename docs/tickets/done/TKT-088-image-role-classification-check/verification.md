...
DONE. The ticket's decision fork was resolved by events: auto role classification SHIPPED (TKT-064) and is LIVE (IMAGE_ROLE_CLASSIFY_ENABLED=true verified; new intakes stamp roles; the TKT-131 backfill closed the historical gap — 1,998/2,002). The premise ("never built") was stale and is corrected in changes.md; the determination + the follow-up path (event-time Box classify -> TKT-146) are recorded. The three-way operator decision is moot: option (1) is reality.
