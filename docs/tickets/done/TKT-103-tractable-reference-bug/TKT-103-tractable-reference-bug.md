...
- Shared samples live in the primary Tractable ticket:
  [TKT-102/evidence/tractableexamples/](../../verify/TKT-102-tractable-received-handling/evidence/tractableexamples)
...
(`tractable-received.md`). Split from [TKT-102](../../verify/TKT-102-tractable-received-handling/TKT-102-tractable-received-handling.md)
