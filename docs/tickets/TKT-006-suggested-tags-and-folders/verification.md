...
[live-environment.md](../../architecture/live-environment.md) for current intake/subscription state).
...
email lands; confirm they are non-NULL and map to the expected choiceset labels.
