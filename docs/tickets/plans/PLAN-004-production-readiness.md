...
5. [TKT-155](../verify/TKT-155-dashboard-three-state-layout/TKT-155-dashboard-three-state-layout.md), [TKT-157](../backlog/TKT-157-handler-copy-audit/TKT-157-handler-copy-audit.md), and [TKT-163](../backlog/TKT-163-merge-dialog-layout/TKT-163-merge-dialog-layout.md) — complete the handler-facing workflow.
