...
Retro-registers the case-done lifecycle cluster. The verbatim operator plan remains in the anchor ticket evidence for [TKT-094](../verify/TKT-094-case-done-status-model/TKT-094-case-done-status-model.md).
