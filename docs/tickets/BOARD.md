...
| [TKT-058](./TKT-058-retro-case-creation/TKT-058-retro-case-creation.md) | Retroactive case creation — reconstruction fallback for un-linked update/billing email ([ADR-0022](../adr/0022-retroactive-case-reconstruction.md)) | **R1 BUILT 2026-07-04, ships dark** (gates unset — behaviour unchanged): any-status link rung + ladder scaffold + keyed drain starter; offline gates green, bundles rebuilt, NOT yet deployed. Pending: deploy + the `2026-07-04-retro-case` DDL delta + `RETRO_CASE_ENABLED` flip ([gated.md D11](../gated.md)), then the R2 Box-archive + R3 Outlook rungs. See [verification](./TKT-058-retro-case-creation/verification.md). |
