...
research-link: docs/tickets/now/TKT-214-repository-gates-ci-closeout/evidence/operator-note.md
plan: PLAN-006
---
...
- **A4.** Controlled failing fixtures cover an unexplained inventory path, wrong target path, stale retired-platform variant, changed evidence hash, missing logical occurrence, production fixture import, broken/known-absent link, ticket/plan drift and edited adapter.
- **A5.** The gate fails for archive/stub/build/dependency output, an extra top-level source root, an unowned generated artifact or a remaining former path.
