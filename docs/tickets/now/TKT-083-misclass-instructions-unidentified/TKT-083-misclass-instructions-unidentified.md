...
research-link: docs/tickets/now/TKT-083-misclass-instructions-unidentified/evidence/operator-note.md
---
...
- [ ] Any email where the engine surfaces ≥ the instruction-wording signal plus a ref or VRM does
