...
research-link: docs/tickets/now/TKT-209-monorepo-path-migration-generated-output-removal/evidence/operator-note.md
plan: PLAN-006
---
...
## Proposed change
Apply the TKT-207 path map into /apps, /services, /packages, /contracts, /database, /infrastructure, /tests, /docs, /scripts, /tools and /workingspace. Update all repository-local path consumers atomically, remove non-source outputs, and retain no redirect directory or compatibility stub.
