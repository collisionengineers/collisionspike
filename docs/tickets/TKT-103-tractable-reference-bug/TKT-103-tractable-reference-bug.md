...
research-link: docs/tickets/TKT-103-tractable-reference-bug/evidence/operator-note.md
---
...
- Shared samples live in the primary Tractable ticket:
  [TKT-102/evidence/tractableexamples/](../TKT-102-tractable-received-handling/evidence/tractableexamples/)
...
(`tractable-received.md`). Split from [TKT-102](../TKT-102-tractable-received-handling/TKT-102-tractable-received-handling.md)
(email handling) and [TKT-104](../TKT-104-tractable-api-integration/TKT-104-tractable-api-integration.md)
(deferred API).
