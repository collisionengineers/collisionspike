...
# Function Apps — which functions are actually deployed (verified 2026-06-30T20:40Z: orch 48, api 63, parser 3)
az functionapp function list -g rg-collisionspike-dev -n cespk-api-dev  -o table   # expect: 63 functions
