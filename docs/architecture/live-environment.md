...
> re-embedding a count. Last live change: **2026-07-03T15:40Z** — the **nine-task activation** (user-instructed):
...
# Function Apps — which functions are actually deployed (verified 2026-07-03T15:30Z: orch 53, api 77, parser 3)
az functionapp function list -g rg-collisionspike-dev -n cespk-api-dev  -o table   # expect: 77 functions
az functionapp function list -g rg-collisionspike-dev -n cespk-orch-dev -o table   # expect: 53 functions (live in testing — 3 push subs)
