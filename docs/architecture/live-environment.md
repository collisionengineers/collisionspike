...
# Function Apps — which functions are actually deployed (verified 2026-06-30: orch 48, api 58)
az functionapp function list -g rg-collisionspike-dev -n cespk-api-dev  -o table   # expect: 58 functions
