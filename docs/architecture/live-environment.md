...
> re-embedding a count. Last live change: **2026-07-02T16:05Z** — **TKT-054 deploy** (inbox
...
# Function Apps — which functions are actually deployed (verified 2026-07-02T15:55Z: orch 53, api 72, parser 3)
az functionapp function list -g rg-collisionspike-dev -n cespk-api-dev  -o table   # expect: 72 functions
