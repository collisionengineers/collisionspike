...
_Cross-cutting prioritization for the `collisionspike` M1 spike. Companion to [CURRENT_STATUS.md](../../CURRENT_STATUS.md), [ROADMAP.md](../../ROADMAP.md), [PLAN.md](../HISTORICAL/PLAN.md). Lanes 1–3 (Power-Platform-native, Azure/AI, domain/workflow) hold the per-feature detail; this lane stays at the **prioritization and sequencing altitude**. Date: 2026-06-18._
