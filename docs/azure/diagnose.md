...
- Orch: `az functionapp function list -g rg-collisionspike-dev -n cespk-orch-dev --query "[].name"` → the
  orch count in the registry [live-environment.md](../architecture/live-environment.md) (`0` = the registration crash).
