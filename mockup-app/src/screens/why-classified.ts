/* ============================================================
   ...
   docs/plans/rules_engine_v2_plan_9ba034c4.plan.md Phase 5.
   ...
   map to the same phrase:
     - the vendored engine's current signal format
       (functions/parser/cedocumentmapper_v2/rules/email_classifier.py, e.g.
       `work_keywords:please inspect`, `provider_match_state:one`,
       `rule:instruction_doc_existing_provider`), and
     - a couple of legacy/shorthand spellings already seeded in the SPA's own
