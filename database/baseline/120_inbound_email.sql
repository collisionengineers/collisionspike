-- =============================================================================
-- 120_inbound_email.sql -- inbound-email triage (ADR-0015)
...
-- triage_state + classifier_mode are deliberately short String tokens (not code tables):
-- low-churn workflow/source flags used by current services.
--
...
CREATE TABLE inbound_email (
  ...
  name              varchar(200) NOT NULL,       -- triage label
...
COMMENT ON TABLE inbound_email IS 'Triage audit-of-record; one row per inbound email; classifier never auto-links.';
