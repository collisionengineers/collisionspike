-- =============================================================================
-- 050_case.sql -- central work item
...
CREATE TABLE case_ (
  ...
  -- required human label, not the Case/PO
  ...
  -- ---- Archive one-way mirror (ADR-0012) -----------------------------------
  ...
  -- geolocation clue, not one of the 12 EVA fields
...
COMMENT ON TABLE  case_ IS 'Central work item. EVA payload = the 12 eva_* columns only; vrm/case_ref/case_po are identity, never EVA fields.';
