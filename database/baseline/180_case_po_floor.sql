...
-- (services/data-api/src/features/cases/case-po.ts) allocates GREATEST(db_max, floor_seq) + 1, so the live
...
-- Seeded from authoritative Archive folder names and EVA maxima; the enduring sequence
-- rule is in docs/adr/0021-case-po-marker-taxonomy.md. RLS/GRANT in 900_constraints.sql (+ the
