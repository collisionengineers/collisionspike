-- =============================================================================
-- 070_field_level_provenance.sql -- per-field source and review records
...
COMMENT ON TABLE field_level_provenance IS 'Per (case, field) source + review; multiple source/conflict rows allowed per field.';
