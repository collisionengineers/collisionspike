-- =============================================================================
-- 020_repairer.sql -- repairer corpus table (ADR-0001)
...
CREATE TABLE repairer (
  ...
  -- natural upsert/dedup key for the garage reseed
  CONSTRAINT uq_repairer_name_postcode UNIQUE (name, postcode)
);

COMMENT ON TABLE repairer IS 'Garage/bodyshop directory; many-to-many with work_provider; deactivate/merge, never hard-delete.';
