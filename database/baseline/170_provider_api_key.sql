...
-- -----------------------------------------------------------------------------
-- Current table backing provider API credentials.
...
COMMENT ON COLUMN provider_api_key.key_hash IS
  'SHA-256 hex of the full secret. Compared with crypto.timingSafeEqual in services/data-api/src/platform/auth/api-key-auth.ts; the plaintext is shown once at mint and never stored.';
