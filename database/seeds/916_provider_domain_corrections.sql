...
--
-- Idempotent. Apply after the base corpus load and 915_corpus_email_address_match.sql (or
...
--   provider corpus        : PHA,Parkhouse Assist
--   provider domain source : PHA,parkhouseassist.com
-- =============================================================================
