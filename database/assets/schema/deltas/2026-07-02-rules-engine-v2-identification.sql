...
-- -----------------------------------------------------------------------------
-- PURPOSE. Seeds the ADR-0011 Image-Source intermediary corpus for the rules-engine-v2
-- plan's Phase 3 (identification upgrade):
--   docs/plans/rules_engine_v2_plan_9ba034c4.plan.md  (Phase 3)
...
--   docs/gated.md  item D8 (this delta's apply runbook + why-you)
-- Concretely:
...
-- normal, handled case -- see api/src/functions/internal.ts). Applying this delta is
...
--     (functions/parser/.venv) and returned work_provider.value = "PCH" at confidence
...
--     "PCH" principal_code (docs/plans/phase-1-intake-and-case-tracking/corpus/
--     clarifying-info-ingestion.md: "PCH (1,725 cases)"; docs/research/03-domain-
--     workflow.md). ADR-0014 confirms the "A." seen on real folder names like
...
-- in this session; 910_seed_corpus.sql's \copy sources under raw/ and dataverse/.build/
...
-- delta; see docs/azure/postgres.md for the general pattern and docs/gated.md item D8
...
--      application login cespk_app does NOT own these tables (by design -- see A2 in
--      docs/gated.md) and work_provider/image_source/imagesource_workprovider all carry
...
--   4. Apply this file:
--        collisionspike=> \i migration/assets/schema/deltas/2026-07-02-rules-engine-v2-identification.sql
