...
-- -----------------------------------------------------------------------------
-- PURPOSE. Adds the Phase-2 taxonomy + capture columns for the rules-engine-v2 plan:
--   docs/plans/rules_engine_v2_plan_9ba034c4.plan.md  (Phase 2 + "Operator gates")
--   docs/gated.md  item D7 (this delta's apply runbook + why-you)
-- Concretely:
...
-- docs/azure/postgres.md for the general connection pattern and docs/gated.md item D7
...
--   4. Apply this file:
--        collisionspike=> \i migration/assets/schema/deltas/2026-07-02-rules-engine-v2-taxonomy.sql
...
-- Graph $select in orchestration/src/lib/graph.ts and carried in the envelope; the
