...
-- corrected, geocoded corpus emitted by scripts/inspection-corpus/build_corpus.py +
...
--   psql "<conn>" -v csvpath='/abs/path/migration/assets/schema/seed/data/inspection-suggestions.csv' \
--        -f migration/assets/schema/seed/920_replace_suggested_addresses.sql
-- (Run as an owner/role that bypasses RLS -- e.g. SET ROLE csadmin -- see docs/azure/postgres.md.)
