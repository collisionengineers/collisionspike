...
-- Box FILE.UPLOADED row (services/functions/box-webhook/data_api_client.py, "the API
...
--   --    the exact status_code values from the case-status code table /
--   --    packages/domain/src/contracts/case-status.ts; terminal = eva_submitted / removed / error):
