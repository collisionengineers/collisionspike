...
-- Mirrors packages/domain/src/data/code-tables/inbound-email-classification.json
...
--   4. \i database/migrations/2026-07-09-taxonomy-v3-pre-instruction-payments.sql
--   5. Verify:
