...
vi.mock('../lib/capture-auth.js', async (importOriginal) => ({
  ...(await importOriginal<typeof import('../lib/capture-auth.js')>()),
  ...captureAuth,
}));
...
vi.mock('../lib/upload-validate.js', () => ({
...
vi.mock('../lib/case-mutation-locks.js', () => locks);
