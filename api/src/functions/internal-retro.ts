/**
 * api/src/functions/internal-retro.ts — retro case reconstruction routes (ADR-0022 / TKT-058).
 *
 ...
 * (orchestration/src/functions/gated/retro-case.ts) first asks this surface whether the
...
import { type ParserEvaFields } from '../lib/parser-eva-fields.js';
