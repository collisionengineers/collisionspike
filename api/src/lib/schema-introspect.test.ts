/**
 * api/src/lib/schema-introspect.test.ts — the pure SQL-assembly branch (no DB).
...
import { planOptionalColumns, type OptionalColumnCandidate } from './schema-introspect';
