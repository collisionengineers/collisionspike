...
const delta=readFileSync(new URL('../../../migration/assets/schema/deltas/2026-07-13-tkt034-archive-holding.sql',import.meta.url),'utf8');
const canonical=readFileSync(new URL('../../../migration/assets/schema/197_archive_holding.sql',import.meta.url),'utf8');
const constraints=readFileSync(new URL('../../../migration/assets/schema/900_constraints.sql',import.meta.url),'utf8');
