/**
 * api/src/lib/evidence-bytes.ts — resolve an evidence artifact's raw bytes (TKT-048/077).
 *
...
import { downloadEvidenceBytes } from './blob.js';
import { downloadBoxFileContent } from './functions-client.js';
