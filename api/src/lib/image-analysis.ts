/**
 * api/src/lib/image-analysis.ts — the staged image-analysis suggestion PRODUCER (TKT-016).
 *
 ...
 * proof). The gated HTTP route (api/src/functions/image-analysis.ts) wires the REAL adapters
