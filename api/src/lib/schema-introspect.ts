/**
 * api/src/lib/schema-introspect.ts — cached information_schema.columns existence probe +
 ...
 * (migration/assets/schema/deltas/2026-07-02-rules-engine-v2-taxonomy.sql) lands live —
