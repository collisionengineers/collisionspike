...
- **Builds on, never contradicts:** ADR-0010/0015/0019/0023/0024/0025 (amendment candidates
  are explicit — Q1–Q5), [PLAN-001](../../docs/tickets/plans/PLAN-001-ai-mcp-hardening.md), the
  completed rules-engine-v2 plan (retired in the PLAN-006 reset), and the
  `scripts/eval-email/` harness ([README](../../scripts/evaluation/email/README.md)).
