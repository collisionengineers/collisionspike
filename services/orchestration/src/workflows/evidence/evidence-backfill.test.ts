...
vi.mock('../../platform/image-classify.js', () => imageClassify);
...
vi.mock('../../adapters/data-api.js', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../../adapters/data-api.js')>();
...
} = await import('../../adapters/data-api.js');
