 ...
 *      `unknown` [no 'other' code-table option] + not accepted; person reflection →
...
} from '../../platform/image-classify.js';
import { box } from '../../adapters/functions-client.js';
import { deleteEvidenceBytes, downloadEvidenceBytes } from '../../platform/blob.js';
import {
  dataApi,
