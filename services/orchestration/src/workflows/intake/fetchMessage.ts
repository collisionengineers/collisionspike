...
import { getMessageWithAttachments, getMessageHeaders, getMessageRawMime } from '../../adapters/graph.js';
import {
  mailboxOfResource,
...
import { rawEmlFileName } from '../../platform/evidence-names.js';
...
export interface InboundEnvelope {
  ...
  references: string;
  /** Recipient-stamped Authentication-Results header, when available. */
