 ...
 *
 * CONTRACT (parser /api/parse, verified in services/functions/parser/function_app.py):
 ...
 * text-length to threshold on (see services/functions/parser/function_app.py's response shape), so
