...
vi.mock('../lib/supplement-parse.js', () => ({
...
vi.mock('./activities/imagesReceivedVrmMatch.js', () => ({
  shouldAttemptPdfVrmMatch: () => false,
}));
vi.mock('./activities/reply-link-eligibility.js', () => ({
  shouldLinkReplyToCase: () => false,
}));
vi.mock('./gated/triage-classify.js', () => ({
...
vi.mock('../lib/vehicle-data-intake.js', () => ({
