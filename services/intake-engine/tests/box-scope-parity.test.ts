 ...
 *
 * box-scope-guard.ts compiles the root in as a literal because the orchestration service
...
import { PINNED_ARCHIVE_ROOT_ID, resolveArchiveRoot } from '../src/adapters/box-scope-guard.js';
