/**
 * services/data-api/src/shared/audit.ts — append-only audit_event writer.
 *
 * Enforces the append-only audit invariants:
...
export const AUDIT_ACTION = {
  ...
  // database/migrations/2026-07-02-rules-engine-v2-taxonomy.sql, NOT YET applied
