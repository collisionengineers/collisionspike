/**
 * api/src/lib/functions-client.test.ts — OFFLINE proof that the latency-sensitive image-analysis
...
import { callPlateOcr, callLocationSuggest, callParser, FN_STAGE_TIMEOUT_MS } from './functions-client.js';
