/**
 * services/data-api/src/features/assistant/image-analysis-adapters.ts — the NETWORK-backed stage adapters for the image-analysis
...
import { mintCognitiveToken } from './chat-client.js';
import { callPlateOcr, callLocationSuggest, FN_STAGE_TIMEOUT_MS } from '../../platform/http/service-client.js';
