/**
 * services/data-api/src/features/assistant/suggestion-client.ts — keyless Azure OpenAI (Foundry) structured-output client for
 ...
 *     (services/orchestration/src/adapters/aoai.ts): AOAI GA v1 `POST {endpoint}/openai/v1/chat/completions`,
