/**
 * services/data-api/src/features/assistant/image-analysis-routes.ts — the GATED, additive image-analysis suggestion producer
...
import { resolveBytesForRow, ASSIST_MAX_BYTES_PER_PHOTO, type EvidenceByteRow } from '../evidence/bytes.js';
import { makeImageAnalysisAdapters } from './image-analysis-adapters.js';
import {
  runImageAnalysis,
  type CaseContext,
  type ImageInput,
