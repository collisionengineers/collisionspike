...
import { authenticate, mcpPrincipalKind, toErrorResponse } from '../../platform/auth/staff-auth.js';
import { assertStaffRlsContext } from '../../platform/db/client.js';
import { execTool } from './chat-routes.js';
import type { ToolExecutor } from './chat-client.js';
import {
...
} from '../cases/mcp-image-ingestion.js';
