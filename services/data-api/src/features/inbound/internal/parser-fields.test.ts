/**
 * services/data-api/src/features/inbound/internal/parser-fields.test.ts — applyParserFields provider resolution (TKT-065).
 *
...
import { applyParserFields } from './parser-fields.js';
import { buildHeldReason } from '../../cases/held-reason.js';
import '../../cases/internal-resolution-routes.js';
import { exactCaseForSourceMessage } from './inbound-identity.js';
