/**
 * services/data-api/src/features/cases/chase-route.test.ts — POST /api/cases/{id}/chase (M-E2 durable chaser log).
 *
...
vi.mock('../archive/file-request-outbox.js', () => ({
...
import { rowToChaser } from './case-support.js';
import './queue-action-routes.js';
