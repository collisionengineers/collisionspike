/**
 * services/data-api/src/features/cases/dashboard-routes.test.ts — pure aggregate compute helpers (no DB/auth/host).
...
import { filterQueue } from '../../shared/mapping/index.js';
