/**
 * services/data-api/src/features/cases/overview-chase.test.ts — OFFLINE proof for the TKT-148 overview-photo
...
describe('TKT-148 migration contract', () => {
  it('deduplicates only the exact system signature before adding the partial unique index', () => {
    const sql = readFileSync(
      new URL(
        '../../../../../database/migrations/2026-07-11-tkt148-chaser-suggestions.sql',
        import.meta.url,
      ),
      'utf8',
    );
