...
vi.mock('../../platform/http/service-client.js', () => ({ callVehicleData: canonical.callVehicleData }));
...
vi.mock('../inbound/internal/service-support.js', () => ({ recomputeStatus: status.recomputeStatus }));
