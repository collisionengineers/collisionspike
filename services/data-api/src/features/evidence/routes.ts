/**
 * services/data-api/src/features/evidence/routes.ts — serve an evidence artifact's bytes (TKT-048).
 *
...
import { resolveBytesForRow, type EvidenceByteRow } from './bytes.js';
import { AUDIT_ACTION, actorFromClaims, writeAudit } from '../../shared/audit.js';
import { rowToEvidence, type Row } from '../../shared/mapping/index.js';
...
/* ============================================================
   ...
   non-classifier exclusion. The existing reflection-dismiss body remains accepted.
   ============================================================ */
