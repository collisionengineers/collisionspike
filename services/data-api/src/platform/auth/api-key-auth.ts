/**
 * services/data-api/src/platform/auth/api-key-auth.ts — X-Api-Key authentication for the provider intake channel.
 *
...
import { HttpError, toErrorResponse } from './staff-auth.js';
