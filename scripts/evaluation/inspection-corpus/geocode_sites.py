...
Stdlib only (urllib + json). Usage:
  python scripts/evaluation/inspection-corpus/geocode_sites.py \
     [--csv database/seeds/data/inspection-suggestions.csv] \
     [--cache scripts/evaluation/inspection-corpus/reports/postcode-geocache.json] \
...
def main(argv=None):
    ...
    ap.add_argument("--csv", default="database/seeds/data/inspection-suggestions.csv")
    ap.add_argument("--cache", default="scripts/evaluation/inspection-corpus/reports/postcode-geocache.json")
