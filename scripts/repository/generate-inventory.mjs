...
const DEFAULT_OUTPUT = "docs/repository/repository-inventory.json";
...
function categoryFor(repositoryPath, kind = "file") {
  ...
  if (value.startsWith(".plan-") && value.includes("-baseline/")) return "repository-baseline";
...
function ownerFor(repositoryPath) {
  ...
  if (value.startsWith(".plan-") && value.includes("-baseline")) return "repository-governance";
  ...
  if (value.startsWith("docs/")) return "documentation";
  if (value.startsWith("scripts/repository/") || value.startsWith(".github/")) return "repository-governance";
...
function lifecycleFor(repositoryPath, kind = "file") {
  ...
  if (kind === "directory") {
    ...
    if (value.startsWith("docs/historical")) return "retirement-candidate";
    if (value.startsWith("deploy") || (value.startsWith(".plan-") && value.includes("-baseline"))) return "generated";
    return "structural";
  }
  if (value === DEFAULT_OUTPUT) return "generated";
  if (value.startsWith(".plan-") && value.includes("-baseline/")) return "generated";
  if (value.startsWith("docs/workingspace/")) return "working";
  if (value.includes("/evidence/") || value.startsWith("test-cases-and-data/") || value.startsWith("project-demo/")) return "evidence";
  if (value.includes("/vendor/") || value.includes("/vendor_")) return "vendored";
  if (value.startsWith("deploy/") || value.match(/(?:^|\/)(?:dist|build|coverage)\//) || value.includes(".generated.")) return "generated";
  if (value.startsWith("docs/historical/")) return "retirement-candidate";
  return "active";
}
