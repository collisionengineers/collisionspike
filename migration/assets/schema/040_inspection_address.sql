-- =============================================================================
-- 040_inspection_address.sql  --  cr1bd_inspectionaddress  (corpus + per-case table)
...
CREATE TABLE inspection_address (
  ...
  label                varchar(200) NOT NULL,       -- primaryColumn cr1bd_name (required)
  ...
  -- cr1bd_inspectionaddress_label_key (atomic PATCH-to-key upsert for the suggestions reseed)
...
COMMENT ON TABLE inspection_address IS 'cr1bd_inspectionaddress -- per-case location or suggested catalogue row; image_based requires a reason.';
