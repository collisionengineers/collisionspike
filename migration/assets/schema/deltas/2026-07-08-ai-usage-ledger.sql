...
-- (TKT-113, PLAN-001 Phase 4; docs/gated.md step 5). Adds the AI model-usage ledger:
...
-- recordAiUsage() writer (api/src/lib/ai-usage.ts, called from api/src/functions/
-- assistant.ts on the /api/assistant/chat path). The writer is deliberately best-effort
