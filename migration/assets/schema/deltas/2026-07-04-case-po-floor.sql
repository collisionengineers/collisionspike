...
-- system-minted-at-intake (TKT-058; ADR-0022 Consequences addendum; runbook
-- docs/plans/case-po-sequence-cutover.md): `case_po_floor` carries the
...
--
-- APPLY RUNBOOK: docs/azure/postgres.md connection pattern (transient firewall
