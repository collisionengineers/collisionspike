...
3. **The plan floor is Box Business Plus (~$25–33/user/mo, 3‑seat minimum ≈ $900/yr list)** — because
   **Metadata** (needed to capture the registration on the upload form) is gated at Business Plus and
   above. File Requests alone need only Business; the structured‑capture use case forces Business Plus.
...
price above several TB on hot storage (Blob Cool/Cold/Archive always undercut it). **The justification
must be workflow, UX, external‑upload ergonomics and governance — never price.**
...
| 4 | File Request + Webhooks + Metadata on one realistic plan | **Confirmed** | **Business Plus (~$25–33/user/mo, 3‑seat min)** — Metadata is the gate |
...
| 8 | Permanent File Request links per image‑only sender | **Confirmed** | Real (one folder per sender); registration capture needs **Business Plus** metadata |

---

## What it would cost (orientation — detail in [02‑plans‑and‑cost.md](./02-plans-and-cost.md))

- **Box licence:** Business Plus, ~$25–33/user/mo annual list, **3‑seat minimum ≈ $900/yr** even for 1–2
  real users. (GBP not machine‑readable on box.com; figures are USD list from box.com + trackers.)
...
| [02‑plans‑and‑cost.md](./02-plans-and-cost.md) | Plan ladder, the Business‑Plus floor & why, add‑ons, the Azure‑vs‑Box cost comparison |
